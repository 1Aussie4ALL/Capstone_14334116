...
class VariationADatasetCreator:
    def __init__(self, seed=42):
        """Initialize the Variation A dataset creator."""
        random.seed(seed)
        np.random.seed(seed)
        
        # Source and destination paths
        self.dataset_path = "Dataset/Training"
        self.data_used_path = "data_used_for_variation_A"
        self.results_path = "Variation A_results"
        ...
        self.images_per_class = 100
        
    def copy_original_images(self):
        """Copy original images to data_used_for_variation_A folder."""
        print("📁 Copying original images to data_used_for_variation_A...")
        ...
        for cancer_type in self.cancer_types:
            ...
            for i, image_file in enumerate(selected_images):
                ...
                dest_path = os.path.join(dest_dir, f"{cancer_type}_{i+1:03d}_{image_file}")
    ...
    def create_summary_report(self):
        ...
        # Save report
        with open("Variation_A_Summary_Report.txt", "w") as f:
            f.write("\n".join(report))
    ...
    def run_full_process(self):
        ...
        print("🚀 Starting Variation A Dataset Creation Process...")
...
def main():
    ...
    creator = VariationADatasetCreator(seed=42)
