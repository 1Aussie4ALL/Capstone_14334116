...
def predict_image(model, image_path, class_names, img_size=(64, 64)):
    """
...
def main():
    ...
    model_path = 'brain_tumor_classifier_instant.h5'
    class_names = ['glioma', 'meningioma', 'notumor', 'pituitary']
    
    # Check if model exists
    if not os.path.exists(model_path):
        print(f"Error: Model file '{model_path}' not found!")
        print("Please run 'train_instant.py' first to train the model.")
        print("This will take only a few minutes!")
        return
    
    # Load the trained model
    print("Loading instant trained model...")
    try:
    ...
    print("\n🚀 INSTANT Brain Tumor Classification Model")
    print("=" * 50)
